const Settings = () => {
  return (
    <div className="flex flex-col items-center justify-center py-20 bg-(--bg-card) border border-(--glass-border) rounded-3xl border-dashed">
      ...
      <h3 className="text-xl font-bold text-(--text-primary)">System Settings</h3>
      <p className="text-(--text-muted) text-center max-w-sm mt-2">Configure threshold alerts and AI optimization parameters.</p>
    </div>
  );
};
