...
const AdminPage = () => {
  ...
  // DATA REDUCED TO 3 CORE PROJECTS AS REQUESTED
  const adminAssets = [
  ...
  return (
    <div className="flex h-screen bg-(--bg-base) text-(--text-primary) overflow-hidden">
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden overflow-y-auto">
        <header className="h-20 bg-(--bg-base)/80 backdrop-blur-md border-b border-(--glass-border) px-8 flex items-center justify-between sticky top-0 z-40 shrink-0">
          ...
          <div className="flex items-center gap-6 ml-6">
            <div className="flex items-center gap-3 pl-6 border-l border-(--glass-border)">
              <div className="text-right">
                ...
                <p className="text-[10px] text-green font-black uppercase tracking-widest mt-1">Super Admin</p>
              </div>
